...
function generateRonaldoBirds() {
    return `
        ...
        <div style="text-align: center; max-width: 500px; margin: 0 auto; padding: 2rem;">
            <canvas id="ronaldoCanvas" width="400" height="600" style="border: 2px solid var(--neon-blue); border-radius: 5px; background: var(--bg-dark); display: block; margin: 1rem auto;"></canvas>
            <div style="margin: 1rem 0;">
